class StatisticsController < ApplicationController 
  ...
  def index
    ...
    ### Monthly
    @total_repairs             = @cars.total_repairs(*params_m)
    @total_chargings           = @cars.total_chargings(*params_m)
    @total_taxes               = @cars.total_taxes(*params_m)
    @all_car_repairs           = @cars.all_car_repairs(*params_m)
    @all_car_chargings         = @cars.all_car_chargings(*params_m)
    @all_car_taxes             = @cars.all_car_taxes(*params_m)
    ...
    ### Yearly
    @total_repairs_year        = @cars.total_repairs_year(*params_y)
    @total_chargings_year      = @cars.total_chargings_year(*params_y)
    @total_taxes_year          = @cars.total_taxes_year(*params_y)
    @all_car_repairs_year      = @cars.all_car_repairs_year(*params_y)
    @all_car_chargings_year    = @cars.all_car_chargings_year(*params_y)
    @all_car_taxes_year        = @cars.all_car_taxes_year(*params_y)
